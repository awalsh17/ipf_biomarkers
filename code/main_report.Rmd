...
The primary objective of the collaboration is to discover circulating biomarkers of IPF while on treatment.
...
The clinical data and molecular data are loaded. Alice also manually mapped the identifiers for the 26 proteins to official gene symbols (when they existed) so we could have a common set of identifiers across all analysis.
...
Results are grouped into the three biological function groups: epithelial damage, ECM remodeling, and inflammation.
